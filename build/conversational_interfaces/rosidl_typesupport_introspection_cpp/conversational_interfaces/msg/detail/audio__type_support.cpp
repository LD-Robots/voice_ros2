...
{
  new (message_memory) conversational_interfaces::msg::Audio(_init);
}

void Audio_fini_function(void * message_memory)
{
  auto typed_message = static_cast<conversational_interfaces::msg::Audio *>(message_memory);
  typed_message->~Audio();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Audio_message_member_array[3] = {
  {
    "sample_rate",  // name
    ...
    offsetof(conversational_interfaces::msg::Audio, sample_rate),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(conversational_interfaces::msg::Audio, channels),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(conversational_interfaces::msg::Audio, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Audio_message_members = {
  ...
  "Audio",  // message name
  3,  // number of fields
  sizeof(conversational_interfaces::msg::Audio),
...
{
  return &::conversational_interfaces::msg::rosidl_typesupport_introspection_cpp::Audio_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, conversational_interfaces, msg, Audio)() {
  return &::conversational_interfaces::msg::rosidl_typesupport_introspection_cpp::Audio_message_type_support_handle;
}
