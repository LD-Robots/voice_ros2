...
#include "conversational_interfaces/msg/detail/text_chunk__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = conversational_interfaces::msg::TextChunk;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const conversational_interfaces::msg::TextChunk *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<conversational_interfaces::msg::TextChunk *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TextChunk__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const conversational_interfaces::msg::TextChunk *>(
...
static size_t _TextChunk__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TextChunk(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TextChunk__callbacks = {
...
static rosidl_message_type_support_t _TextChunk__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TextChunk__callbacks,
...
{
  return &conversational_interfaces::msg::typesupport_fastrtps_cpp::_TextChunk__handle;
}
