...
static const _TextChunk_type_support_symbol_names_t _TextChunk_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, conversational_interfaces, msg, TextChunk)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, conversational_interfaces, msg, TextChunk)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, conversational_interfaces, msg, TextChunk)() {
  return &::conversational_interfaces::msg::rosidl_typesupport_c::TextChunk_message_type_support_handle;
}
