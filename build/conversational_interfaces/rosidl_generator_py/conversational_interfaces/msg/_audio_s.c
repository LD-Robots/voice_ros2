...
bool conversational_interfaces__msg__audio__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("conversational_interfaces.msg._audio.Audio", full_classname_dest, 42) == 0);
  }
  conversational_interfaces__msg__Audio * ros_message = _ros_message;
  {  // sample_rate
...
PyObject * conversational_interfaces__msg__audio__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("conversational_interfaces.msg._audio");
