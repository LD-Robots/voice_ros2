...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('realtime_deep_reason_enabled', default_value='true', description='Allow OpenAI Realtime to escalate hard questions to a stronger text model'),
        DeclareLaunchArgument('realtime_deep_reason_model', default_value='gpt-5.4-mini', description='Responses API model used for deep_reason escalation'),
        DeclareLaunchArgument('realtime_deep_reason_effort', default_value='medium', description='Reasoning effort for deep_reason; leave empty for non-reasoning models'),
        ...
        Node(
            ...
            parameters=[config_file_path, {
                ...
                'deep_reason_enabled': LaunchConfiguration('realtime_deep_reason_enabled'),
                'deep_reason_model': LaunchConfiguration('realtime_deep_reason_model'),
                'deep_reason_effort': LaunchConfiguration('realtime_deep_reason_effort'),
