...
class BargeInNode(Node):
    ...
    def __init__(self):
        ...
        # /stop_playback is the topic that audio_playback_node AND openai_realtime_node
        # actually listen to – without this the barge-in detection had no effect
        # on realtime backend playback.
    ...
    def _trigger_barge_in(self):
        ...
        # Send stop to audio_playback_node and openai_realtime_node
